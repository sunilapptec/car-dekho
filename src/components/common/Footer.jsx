      ...
      <footer className='border-t bottom-1 border-gray-200 p-3 bg-white'>
        <div className='footer-top py-10 border-b bottom-1 border-gray-200'>
          <div className='grid4 items-center containers'>
            {footerTop.map((item) => (
              <div className='box flex items-center tab:flex tab:items-center tab:flex-col' key={item.id}>
            ...
            <ul className='grid4'>
              {footerBottom.map((item, i) => (
                <li key={i} className='block mb-3'>
                  ...
                  {item.links.map((t, i) => (
                    <NavLink to={t.path} key={i} className='text-sm block mb-4 text-gray1'>
                      {t.text} <br />
                    </NavLink>
                  ))}
                </li>
              ...
              <li>
                ...
                <div className='images flex justify-between'>
                  <img src={appstore} alt='appstore' className='mr-3' />
                  <img src={playstore} alt='playstore' />
                </div>

                <h4 className='text-md font-medium my-8'>CarDekho Group Ventures</h4>
                <div className='grid2 tab:flex tab:items-center tab:flex-col'>
                  <img src={f1} alt='f1' />
                  <img src={f2} alt='f2' />
                  <img src={f3} alt='f3' />
                  <img src={f4} alt='f4' />
        ...
        <div className='legal border-t bottom-1 border-gray-200 pt-5'>
          <div className='containers flex justify-between items-center mobile:flex-col'>
            ...
            <div className='connect flex justify-between items-center mobile:mt-3'>
